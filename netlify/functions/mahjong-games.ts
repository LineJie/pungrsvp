...
return Response.json({ error: "Could not create game, please try again", debug: String(e && e.message || e), cause: String(e && e.cause && e.cause.message || ""), code: String(e && e.cause && e.cause.code || e && e.code || "") }, { status: 500 });
        }
  }
