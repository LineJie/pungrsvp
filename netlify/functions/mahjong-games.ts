...
return Response.json({ error: "Could not create game, please try again", debug: String(e && e.message || e), code: String(e && e.code || ""), detail: String(e && e.detail || ""), hint: String(e && e.hint || ""), keys: Object.keys(e || {}).join(",") }, { status: 500 });
        }
  }
