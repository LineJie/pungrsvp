...
return Response.json({ error: "Could not create game, please try again", debug: String(e && e.message || e), cause: (e && e.cause) ? JSON.stringify(e.cause, Object.getOwnPropertyNames(e.cause)) : "none" }, { status: 500 });
        }
  }
